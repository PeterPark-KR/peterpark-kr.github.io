...
export const pageCopy: Record<Locale, PageCopy> = {
  ...
  ko: {
    ...
    summaries: { about: "회계를 선택한 이유와 공부하고 있는 내용, 가족 사업과 고객 서비스, 해군에서 맡았던 일을 소개합니다.", interests: "한국의 검술 무예인 해동검도: 10년간의 수련, 4단과 사범 자격, 무림피아 종이베기 금상. 골프 이야기도 담았습니다.", projects: "지속적으로 관리하는 이 웹사이트와 계획 중인 현금흐름 학습 프로젝트입니다." },
  ...
  ja: {
    ...
    summaries: { about: "会計を選んだ理由、学んでいること、家族の事業・接客・海軍で担当した仕事について。", interests: "韓国の剣術武道Haedong Kumdo：10年間の稽古、4段と指導者資格、Mulimpiaの紙切り種目での金賞。そしてゴルフへの関心。", projects: "更新を続けているこのサイトと、計画中のキャッシュフロー学習プロジェクト。" },
  ...
  zh: {
    ...
    summaries: { about: "我为什么选择会计、正在学习什么，以及在家庭企业、客户服务和海军中做过的工作。", interests: "韩国剑术武道Haedong Kumdo：十年练习、4段和教练资格，以及Mulimpia斩纸项目金奖。还有我对高尔夫的兴趣。", projects: "我持续维护的这个网站，以及计划中的现金流学习项目。" },
